    ...
    <div className="flex min-h-screen flex-col bg-yellow-400 text-black">
      ...
      <main className="flex-1 mx-auto max-w-7xl px-4 py-8 sm:px-6">
        ...
        <div className="mb-6 grid grid-cols-1 gap-4 md:grid-cols-3">
          <div className="rounded-xl border-2 border-black bg-yellow-500 p-4 shadow-lg">
        ...
        {/* Users Table */}
        <div className="rounded-xl border-2 border-black bg-yellow-500 shadow-lg overflow-hidden">
        ...
        {/* Info Box */}
        <div className="mt-6 rounded-xl border-2 border-black bg-yellow-500 p-4 shadow-lg">
