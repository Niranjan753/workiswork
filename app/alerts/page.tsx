      ...
      <section className="px-6 pb-32 -mt-16 relative z-20">
        <div className="max-w-[800px] mx-auto">
          <div className="bg-white border-2 border-black p-8 sm:p-16 shadow-[12px_12px_0px_black] sm:shadow-[24px_24px_0px_black] text-center">
            ...
            <h2 className="text-2xl sm:text-3xl font-black uppercase italic tracking-tighter mb-6">Initialize Surveillance</h2>
            <p className="text-[10px] sm:text-[11px] font-black uppercase tracking-widest text-gray-500 mb-12 max-w-md mx-auto leading-relaxed">
            ...
            <form className="max-w-md mx-auto flex flex-col gap-4">
              <input
                ...
                className="w-full bg-gray-50 border-2 border-black p-4 sm:p-5 text-black text-[10px] sm:text-[11px] font-black uppercase tracking-widest focus:outline-none focus:ring-2 focus:ring-orange-500 transition-all"
              />
              <button
                type="submit"
                className="w-full bg-black text-white p-4 sm:p-5 text-[10px] sm:text-[11px] font-black uppercase tracking-[0.3em] hover:bg-orange-500 transition-all border-2 border-black"
              >
            ...
            <div className="mt-12 flex flex-wrap items-center justify-center gap-4 sm:gap-6 opacity-40 grayscale">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[9px] font-black uppercase tracking-widest">Encrypted Data</span>
              </div>
              <div className="flex items-center gap-2">
