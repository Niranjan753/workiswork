...
export const getJoinQuestions = (selectedCategory?: string): JoinQuestion[] => {
  ...
  return [
    ...
    },
    {
      ...
      helper: "Select the employment types you're interested in.",
    ...
    {
      id: 4,
      label: "Which regions can you work from?",
      helper: "Select the geographic regions where you can work.",
      placeholder: "Select your work regions",
      options: [
        "Worldwide / Any",
    ...
    },
    {
      ...
      helper: "Select your preferred salary range.",
    ...
    },
    {
      ...
      helper: "Select the regions where you have work authorization.",
      placeholder: "Select work authorization regions",
      options: [
        "US only",
        "Canada",
        "EU",
