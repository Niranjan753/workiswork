        ...
        <div className="bg-white min-h-screen selection:bg-orange-500/30 font-sans">
            ...
            <section className="bg-[#0A0A0A] text-white pt-32 pb-40 px-6 relative overflow-hidden">
                ...
                <div className="max-w-[1200px] mx-auto text-center relative z-10">
                    ...
                    <p className="mt-12 text-lg sm:text-xl md:text-2xl font-medium text-gray-500 max-w-3xl mx-auto leading-tight uppercase tracking-tight">
                    ...
                    <div className="mt-16 flex flex-col sm:flex-row items-center justify-center gap-6">
                        ...
                        <div className="flex flex-col items-start">
                            <span className="text-[10px] font-black text-gray-600 uppercase tracking-widest leading-none">Global Coverage</span>
                            <span className="text-xl font-black italic text-white tracking-tighter">17K+ TALENTS</span>
                        </div>
                    </div>
                </div>
            </section>
