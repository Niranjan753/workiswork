                    ...
                    <div className="bg-white border-2 border-black p-8 sm:p-16 shadow-[12px_12px_0px_black] sm:shadow-[24px_24px_0px_black]">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
                            <div className="space-y-6">
                                <div className="w-12 h-12 bg-black text-white flex items-center justify-center italic text-black text-xl">01</div>
                                <h3 className="text-xl text-black uppercase italic tracking-tighter">The Vision</h3>
                                <p className="text-[11px] text-black uppercase tracking-widest text-gray-600 leading-relaxed">
                            ...
                            <div className="space-y-6">
                                <div className="w-12 h-12 bg-orange-500 text-white flex items-center justify-center italic text-black text-xl">02</div>
                                <h3 className="text-xl text-black uppercase italic tracking-tighter">The Standard</h3>
                                <p className="text-[11px] text-black uppercase tracking-widest text-gray-600 leading-relaxed">
                            ...
                            <div className="space-y-6">
                                <div className="w-12 h-12 bg-black text-white flex items-center justify-center italic text-black text-xl">03</div>
                                <h3 className="text-xl text-black uppercase italic tracking-tighter">The Result</h3>
                                <p className="text-[11px] text-black uppercase tracking-widest text-gray-600 leading-relaxed">
                        ...
                        <div className="mt-20 pt-20 border-t-2 border-dashed border-gray-100 flex flex-col items-center text-center">
                            <h2 className="text-4xl text-black uppercase italic tracking-tighter mb-8 leading-none">Ready to <br /> Initialize?</h2>
                            <div className="flex flex-col sm:flex-row gap-6">
                                <Link
                                    href="/join"
                                    className="bg-orange-500 text-white px-12 py-5 text-[11px] text-black uppercase tracking-[0.3em] hover:bg-black transition-all border-2 border-orange-500"
                                >
                                    Join the Network
                                </Link>
                                <Link
                                    href="/jobs"
                                    className="bg-white text-black px-12 py-5 text-[11px] text-black uppercase tracking-[0.3em] hover:bg-black hover:text-white transition-all border-2 border-black shadow-[8px_8px_0px_rgba(0,0,0,1)] hover:shadow-none"
                                >
                                    Browse Jobs
                                </Link>
                            </div>
